...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        await m.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("⚡ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 ⚡", url="https://t.me/botsbynjboi"), InlineKeyboardButton("📺 Movies 📺", url="https://t.me/movierequestgroupNj")],
...
┃
┣⪼<b>ʙᴏᴛ ɴᴀᴍᴇ : <a href='https://t.me/Filestolinknjboi_bot'>𝗡𝗝 𝗕𝗢𝗜</a></b>
